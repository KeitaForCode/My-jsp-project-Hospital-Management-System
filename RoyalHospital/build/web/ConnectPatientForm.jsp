...
<html>
    ...
    <body>
        ...
        st.executeUpdate("insert into PatientForm(Firstname, Lastname, Gender, DOB, Email, Phone, Address, Diseases, Doc_ID, Doc_Name)values"
       ...
       out.println("location='AddPatient.jsp'");
       out.println("</script>");;
        }catch(Exception e){
        out.println(e);
        }
