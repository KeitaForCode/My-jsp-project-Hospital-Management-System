...
box-shadow: 0px 0px 63px -3px rgba(0,0,0,0.75);
    ...
    <body>
       <div class="container-full bg-dark">
        ...
        <div class="container bg-light bg-transparent">
            <div class="container">
                <form class="col-lg-6 offset-lg-3 styleform" method="post" action="ConnectEmpForm.jsp">
  <div class="form-group form-adjust">
      <h4 class="text-center text-danger">Employees Form</h4>
      <hr>
  </div>
  <div class="form-group form-adjust">
  ...
  <div class="form-group form-adjust">
    ...
    <input type="text" class="form-control" id="exampleInputText" name="add" placeholder="Enter your address">
      </div>
     <div class="form-group form-adjust">
    <label for="exampleInputText">State</label>
    <input type="text" class="form-control" id="exampleInputText" name="state" placeholder="Enter state">
  </div>
      <div class="form-group form-adjust">
    <label for="exampleInputText">Country</label>
    <input type="text" class="form-control" id="exampleInputText" name="country" placeholder="Enter country">
    <br> 
      </div>
