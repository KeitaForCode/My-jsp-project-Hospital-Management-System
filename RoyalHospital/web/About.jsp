...
<html>
    <head>
        ...
        <title>About| Royal Hospital</title>
         <%--bootstrap.css link --%>
      ...
      <ul class="navbar-nav ml-auto">
          ...
          <a class="nav-link" id="change-font" href="Registration.jsp">Register</a>
            ...
            <div class="container-full bg-secondary sticky-top" style="padding: 30px;">
             <h1 class="text-center text-warning changefont">About <span class="changeheader"> Us</span></h1>
             <p class="text-center text-white"><a href="RoyalHomepage.jsp" class="text-white">Home</a> / <a href="#" class="text-danger">About</a></p>
            </div>
        </div>
            <br><br><br>
        <div class="container">
            <p class="paragraphfont">
                Royal Hospitals has consistently been providing healthcare 
                ofinternational standards to the people of Nigeria. Established 
                in 1984 byProfessor Emmanuel and Professor (Mrs.) Oyin Elebute,
                and commencing operationsin 1986 as a provider of integrated healthcare 
                services, Lagoon Hospitals is currentlythe largest private healthcare services
                Group in Nigeria with 6 healthcare facilities.
            </p>
        </div>
            <div class="container">
                <p class="paragraphfont">
                    
Before long, it became obvious that other specialties had to be incorporated partly
due to the success of the centre and partly due to the lack of local specialist services
in those specialties that relate directly with orthopaedic and trauma surgery.

 

The hospital also offer’s specialist services covering internal medicine, 
obstetrics and gynaecology, radiology, rheumatology, ear nose and throat surgery,
dietetics, physiotherapy and general practice.These key specialists are supported by 
highly trained and courteous doctors, nurses, imaging scientists, laboratory scientists,
administrative and ancillary staff who strive to make patients experience at Cedarcrest is as 
pleasant as possible. We work in liaison with centres in the United Kingdom and the United States 
and frequently have visiting surgeons from these foreign hospitals.
                </p>
            </div>
